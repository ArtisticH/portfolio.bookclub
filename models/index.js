...
const TTPD = require('./choice-TTPD');
const HFC = require('./choice-hfc');
const HMC = require('./choice-hmc');
const KFC = require('./choice-kfc');
const KMC = require('./choice-kmc');
const KPOP = require('./choice-kpop');
const POP = require('./choice-pop');
const Quote = require('./quotes');
const RecordsChoice = require('./recordsChoice');
